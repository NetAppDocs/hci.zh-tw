...
如果您要將現有的 Witness 節點就地升級到 Element 12.8 或更高版本，則在升級之前，必須確保 Witness 節點上的 VM 硬體版本與您的環境相容 ESXi 6.7（VM 硬體版本 14）或更高版本。看link:task_hcc_upgrade_management_node.html#upgrade-vm-hardware["升級 VM 硬體版本"]。
