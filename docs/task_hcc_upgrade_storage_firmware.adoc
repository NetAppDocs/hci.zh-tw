...
NOTE: 如需硬體的韌體和驅動程式韌體完整對照表、請參閱 https://docs.netapp.com/us-en/hci/docs/firmware_driver_versions.html["支援的韌體和ESXi驅動程式版本"^]。
...
|===
+
^1^如需硬體的韌體與驅動程式韌體完整對照表、請參閱 https://docs.netapp.com/us-en/hci/docs/firmware_driver_versions.html["支援的韌體和ESXi驅動程式版本"^]。
