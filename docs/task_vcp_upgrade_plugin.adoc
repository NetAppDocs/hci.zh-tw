...
管理服務 2.22.7 套裝組合包含適用於 vCenter Server 5.0 的 Element 插件，其中包含遠端插件。如果您使用 Element 插件，則應升級至管理服務 2.22.7 或更高版本，以符合 VMware 取消本地插件支援的指令。 https://kb.vmware.com/s/article/87880["深入瞭解"^] 。
